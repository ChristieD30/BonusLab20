...
public class ShoppingList2 {
	...
	public static void main(String[] args) {
		...
		String[] products = { "Apple", "Banana", "Tofu", "Cauliflower", "Grapes", "Chips", "Almonds", "Hummus" };
...
//		System.out.println("===========================");
		...
		do {
			...
			System.out.println(
					"Okay, we will add, " + products2.get(number) + " at $" + prices2.get(number) + ", to your cart.");
		...
		printShoppingCart(cartItem, cartPrice);
		...
		System.out.printf("The total of your bill is: $ %.2f" , totalPrices, ".\n");
		System.out.printf("\nWith tax it will be: $ %.2f", tax);

		getAverage(cartPrice, totalPrices);
	...
	private static void printShoppingCart(ArrayList<String> cartItem, ArrayList<Double> cartPrice) {
	...
	private static void getAverage(ArrayList<Double> cartPrice, double totalPrices) {
